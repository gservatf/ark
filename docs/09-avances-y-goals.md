...
- Mantener Auth/RLS como base obligatoria; antes de usuarios reales configurar en Supabase remoto confirmación de email, SMTP real, Google OAuth si aplica, CAPTCHA, URLs de Auth y pruebas multiusuario.
