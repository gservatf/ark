...
- Mantener Auth/RLS como base obligatoria; al pasar a staging o producción configurar confirmación de email, SMTP real, Google OAuth y CAPTCHA remoto.
