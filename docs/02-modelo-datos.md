...
- `can_manage_organization_catalog(p_organizacion_id)` permite mutar catalogos operativos a owner/admin de organizacion o a usuarios con rol `admin` en al menos un proyecto activo de esa organizacion. No habilita invitaciones, creacion de proyectos ni edicion de membresias.
