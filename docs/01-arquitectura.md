...
- Existe migración `20260525165833_project_admin_catalog_permissions.sql` para permitir que un admin de proyecto gestione catalogos operativos compartidos de la organizacion (proveedores, recursos, cotizaciones, partidas y APU) sin obtener permisos administrativos de organizacion.
