...
export const presupuestoPartidaInputSchema = z.object({
  ...
  subcategoria_snapshot: optionalNullableString(),
  especificaciones_snapshot: optionalNullableString(),
  rendimiento_snapshot: nonNegativeNumber("El rendimiento").optional().nullable(),
  jornada_horas_snapshot: nonNegativeNumber("La jornada").optional().nullable(),
  desperdicio_materiales_porcentaje_snapshot: percentage("El desperdicio de materiales").optional().nullable(),
